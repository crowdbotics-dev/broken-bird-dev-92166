"""
Django settings for broken_bird_dev_92166 project.
...
ROOT_URLCONF = 'broken_bird_dev_92166.urls'
...
WSGI_APPLICATION = 'broken_bird_dev_92166.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_bird_dev_92166 API",
    "DESCRIPTION": "API documentation for broken_bird_dev_92166 App",
    "VERSION": "v1",
}
